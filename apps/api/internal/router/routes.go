...
func registerProtectedRoutes(r *gin.Engine, deps routeDependencies) {
	...
	protected.PATCH("/branches/:id/details", middleware.RequireAuth(deps.secret, "admin"), deps.platform.UpdateCompanyBranchDetails)
	...
	protected.GET("/inventory/expiry-settings", deps.platform.GetExpiryWarningSettings)
	protected.PATCH("/inventory/expiry-settings", middleware.RequireAuth(deps.secret, "admin", "franchise_owner", "branch_manager"), deps.platform.UpdateExpiryWarningSettings)
	protected.GET("/inventory/expiry-alerts", deps.platform.ListExpiryAlerts)
	protected.GET("/inventory/expiry-promotion-suggestions", deps.platform.ListExpiryPromotionSuggestions)
	...
	protected.POST("/inspections/randomize-cafe-standard", middleware.RequireAuth(deps.secret, "admin"), deps.platform.RandomizeCafeStandardInspection)
...
func registerAdminRoutes(protected *gin.RouterGroup, deps routeDependencies) {
	...
	protected.GET("/catalog-templates/:id/sync-jobs/latest", middleware.RequireAuth(deps.secret, "admin"), deps.platform.GetLatestCatalogSyncJob)
	protected.GET("/catalog-templates/:id/sync-jobs/:jobId", middleware.RequireAuth(deps.secret, "admin"), deps.platform.GetCatalogSyncJob)
	protected.POST("/catalog-templates/:id/sync-jobs/:jobId/retry", middleware.RequireAuth(deps.secret, "admin"), deps.platform.RetryCatalogSyncJob)
